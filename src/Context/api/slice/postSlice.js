...
export const {
    ...
    useUnionCommentPostMutation,
    useFlameSharePostMutation,
    useUnionSharePostMutation,
    useFlameLikePostMutation,
    useUnionLikePostMutation,
    useFlameLovePostMutation,
    useUnionLovePostMutation,
    useFlameFlagPostMutation,
    useUnionFlagPostMutation,
